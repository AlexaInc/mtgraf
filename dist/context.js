export class Context {
    ...
    reply(text, extra = {}) {
        return this.telegram.sendMessage(this.chatId, text, { ...extra, reply_to_message_id: this.msgId });
    }
    ...
    replyWithContact(phoneNumber, firstName, lastName, extra = {}) {
        return this.telegram.sendContact(this.chatId, phoneNumber, firstName, { ...extra, last_name: lastName });
    }
    replyWithDice(extra = {}) {
    ...
    editMessageReplyMarkup(extra = {}) {
        ...
        return this.telegram.editMessageReplyMarkup(this.chatId, messageId, undefined, extra);
    }
}
